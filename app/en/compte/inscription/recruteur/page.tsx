        ...
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Create your company account to access candidates
            </p>
          </div>

          <div className="mb-6 space-y-3">
            {[
              { title: 'Browse candidates', desc: 'Access international talent pool' },
              { title: 'Post job offers', desc: 'Share opportunities with candidates' },
              { title: 'Manage applications', desc: 'Track all applications in real-time' },
              { title: 'Direct contact', desc: 'Communicate directly with candidates' },
            ].map((item, i) => (
          ...
          <div className="rounded-2xl border border-border bg-background/50 p-6 backdrop-blur-sm">
            <SignUp
              ...
              routing="path"
              path="/en/compte/inscription/recruteur"
