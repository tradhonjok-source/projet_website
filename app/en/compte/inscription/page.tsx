        ...
        <div className="w-full max-w-2xl">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-bold mb-2 gradient-text">
              Create Account - Cabinet DETIE
            </h1>
            <p className="text-muted-foreground">
              Join our international recruitment platform
            </p>
          </div>

          <div className="grid gap-4 md:grid-cols-2 mb-8">
            <Link
              href="/en/compte/inscription/candidat"
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-xl font-bold text-emerald-400">Candidate</h2>
              </div>
              <p className="text-sm text-muted-foreground">
                I am looking for a job in Canada. I can upload my CV and apply for jobs.
              </p>
            </Link>

            <Link
              href="/en/compte/inscription/recruteur"
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-xl font-bold text-violet-400">Recruiter</h2>
              </div>
              <p className="text-sm text-muted-foreground">
                I am an employer. I can browse candidates and post job offers.
              </p>
            </Link>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/en/compte/connexion" className="text-violet-400 hover:text-violet-300 transition-colors font-medium">
                Sign in
              </Link>
            </p>
          </div>
