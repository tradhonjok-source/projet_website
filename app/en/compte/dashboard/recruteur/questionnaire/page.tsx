  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSubmitError(result.error || 'Error submitting');
      }
    } catch (error) {
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              <Input
                ...
                placeholder="Ex: Advanced Technologies Inc."
                required
              />
              <Input
                label="Business Number (NE)"
          ...
          >
            <div className="space-y-4">
              <Checkbox
                label="Are you registered in the lobbyist registry?"
              ...
              {formData.lobbyingInscrit && (
                <>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe your lobbying activities..."
                    rows={3}
                  />
                </>
              )}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Select
                ...
                options={[
                  ...
                  { value: 'manufacturier', label: 'Manufacturing' },
              ...
              <Textarea
                ...
                placeholder="Insurance, RRSP, vacation, etc."
                rows={3}
                className="md:col-span-2"
              />
              <Textarea
                ...
                placeholder="Describe your selection process..."
                rows={4}
                className="md:col-span-2"
              />
            </div>
          ...
          {/* Section 4: International Presence */}
          <SectionCard
            number={4}
          ...
          >
            <div className="space-y-4">
              ...
              <Textarea
                ...
                placeholder="Describe your international recruitment experience..."
                rows={4}
              />
            </div>
          </SectionCard>

          {/* Section 5: Permits and Professional Order */}
          <SectionCard
            number={5}
            title="Permits and Professional Order"
            icon={Award}
          ...
          {/* Section 6: Quebec Operations */}
          <SectionCard
            number={6}
            title="Quebec Operations"
            icon={MapPin}
          ...
          {/* Section 7: Foreign Worker Information */}
          <SectionCard
            number={7}
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Textarea
                ...
                placeholder="Ex: French (native), English (intermediate)..."
                rows={2}
                className="md:col-span-2"
              />
            </div>
          ...
          <SectionCard
            number={8}
            title="Declaration and Electronic Signature"
            icon={Signature}
            ...
            <div className="space-y-4">
              <div className="rounded-xl bg-amber-500/10 border border-amber-500/20 p-4">
                <p className="text-sm text-amber-200 mb-2">
                  I declare that all information provided in this form is accurate and complete.
                  I understand that any false statement may result in the refusal of my application.
                </p>
              </div>
              <Checkbox
                label="I accept and commit"
