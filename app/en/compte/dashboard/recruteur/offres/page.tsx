    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-950/30 via-background to-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <Link
            href="/en/compte/dashboard/recruteur/offres/nouvelle"
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Created on {new Date(offre.createdAt).toLocaleDateString('en-US')}
                      {offre.expiresAt && (
                        <> • Expires on {new Date(offre.expiresAt).toLocaleDateString('en-US')}</>
                      )}
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Link
                      href={`/en/compte/dashboard/recruteur/offres/${offre.id}`}
                    ...
                    <Link
                      href={`/en/compte/dashboard/recruteur/offres/${offre.id}/modifier`}
                      className="p-2 rounded-lg hover:bg-violet-500/10 text-violet-400"
                      title="Edit"
                    >
