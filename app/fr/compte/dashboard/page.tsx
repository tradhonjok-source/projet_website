...
export default function DashboardPage() {
  ...
  // Page de sélection si aucun type n'est défini
  return (
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-emerald-400">Candidat</h2>
              </div>
              <p className="text-muted-foreground mb-4">
                Je cherche un emploi au Canada. Je peux :
              </p>
              <ul className="space-y-2">
                {['Déposer mon CV', 'Postuler aux offres', 'Suivre mes candidatures'].map((item, i) => (
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-violet-400">Recruteur</h2>
              </div>
              <p className="text-muted-foreground mb-4">
                Je suis employeur. Je peux :
              </p>
              <ul className="space-y-2">
                {['Consulter les candidats', 'Publier des offres', 'Contacter les talents'].map((item, i) => (
                  <li key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
