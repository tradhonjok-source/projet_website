...
export default function ModifierOffrePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(`/fr/compte/dashboard/recruteur/offres/${params.id}?updated=success`);
      } else {
        const result = await response.json();
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <Link
              href={`/fr/compte/dashboard/recruteur/offres/${params.id}`}
            ...
            <div>
              ...
              <p className="text-muted-foreground">Modifiez les informations de votre offre</p>
            </div>
          </div>
        </div>
