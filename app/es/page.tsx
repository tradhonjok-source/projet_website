  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-violet-950/50 via-background to-background pt-20">
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
            <div className="text-center max-w-5xl mx-auto">
              ...
              >
                <span className="gradient-text">Bienvenido al Gabinete DETIE</span>
              </motion.h1>
              ...
              >
                Su socio de confianza en <span className="text-violet-400 font-semibold">Reclutamiento Internacional</span> y <span className="text-amber-400 font-semibold">Servicios Administrativos Autorizados</span> en Canadá
              </motion.p>
              ...
              >
                Desde hace más de 10 años, el Gabinete de Experticia DETIE se ha impuesto como un socio privilegiado para empresas y profesionales en búsqueda de excelencia y rigor. Gracias a nuestra doble experiencia en reclutamiento internacional y administración autorizada, acompañamos a nuestros clientes en sus proyectos más estratégicos con un enfoque personalizado y soluciones a medida.
              </motion.p>
        ...
        {/* SECCIÓN 1: RECLUTAMIENTO INTERNACIONAL */}
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                <span className="gradient-text">Conéctese con los Mejores Talentos Mundiales</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Conectamos a empleadores canadienses con los mejores talentos internacionales. De la selección a la integración, lo guiamos en cada paso.
              </p>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 max-w-6xl mx-auto">
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-violet-400">Para los Empleadores</h3>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-emerald-400">Para los Candidatos</h3>
                ...
                <ul className="space-y-4 mb-6">
                  {[
                    ...
                    { icon: Globe, text: 'Soporte para su instalación en Canadá' },
                  ].map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
        ...
        {/* SECCIÓN 2: ADMINISTRADOR AUTORIZADO */}
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-amber-400 uppercase tracking-wider">Administrador Autorizado</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                <span className="gradient-text">Servicios Profesionales Autorizados</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Miembro del Colegio de Administradores Autorizados de Quebec - Canadá. Permiso AdmA A24-52400.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Ayudamos a las entidades en dificultad a superar sus crisis. Análisis, negociación con acreedores, reestructuración de deuda y planes de recuperación.',
                  gradient: 'from-amber-500 to-orange-600'
                },
                {
                  icon: Globe,
                  title: 'Gestión de Activos',
                  desc: 'Nuestros expertos son gestores de activos reconocidos que gestionan y hacen crecer una cartera de inversiones sostenibles.',
                  gradient: 'from-amber-500 to-orange-600'
                },
                {
                  icon: Shield,
                  title: 'Fideicomiso y Mandatario',
                  desc: 'Gestión del dinero de un tercero mediante fideicomiso y cuenta en fideicomiso para proteger los bienes a largo plazo.',
                  gradient: 'from-amber-500 to-orange-600'
                },
                {
                  icon: Zap,
                  title: 'Optimización Estratégica',
                  desc: 'Optimización de la programación estratégica de territorios basada en la concertación local y el análisis de datos.',
                  gradient: 'from-amber-500 to-orange-600'
                },
                {
                  icon: Building2,
                  title: 'Centro Toor Siyo',
                  desc: 'Diseño e implementación de soluciones nuevas con socios mundiales en una dinámica de mejora continua.',
                  gradient: 'from-amber-500 to-orange-600'
                },
                {
                  icon: Target,
                  title: 'Lobby Internacional',
                  desc: 'Representación oficial ante organismos gubernamentales como la OCDE, la ONU o la UE para sus expedientes complejos.',
                  gradient: 'from-amber-500 to-orange-600'
                },
              ].map((service, i) => (
                <motion.div
            ...
            >
              <div className="inline-flex items-center gap-4 px-8 py-4 rounded-full bg-amber-500/10 border-2 border-amber-500/30">
                ...
                <div className="text-left">
                  <div className="text-lg font-bold text-amber-400">Permiso CNESST Válido</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-violet-400 uppercase tracking-wider">Nuestros Valores</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                <span className="gradient-text">Nuestros Valores Fundamentales</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Los principios que guían nuestra acción en el día a día
              </p>
            </div>

            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
              {[
                { icon: Target, title: 'Excelencia', desc: 'Un compromiso constante hacia la calidad y el rendimiento', gradient: 'from-violet-500 to-violet-600' },
                { icon: Shield, title: 'Integridad', desc: 'Prácticas transparentes y éticas en toda circunstancia', gradient: 'from-amber-500 to-amber-600' },
                { icon: Heart, title: 'Compromiso', desc: 'Un acompañamiento personalizado y dedicado a cada cliente', gradient: 'from-purple-500 to-purple-600' },
                { icon: Lightbulb, title: 'Innovación', desc: 'Soluciones creativas adaptadas a los desafíos modernos', gradient: 'from-orange-500 to-orange-600' },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 30 }}
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-amber-400 uppercase tracking-wider">Por Qué Elegirnos</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
              {[
                { icon: Award, title: 'Experiencia Reconocida', desc: 'Miembro OAAQ y CNESST', gradient: 'from-violet-600 to-purple-600' },
                { icon: Clock, title: '10+ Años', desc: 'De experiencia', gradient: 'from-amber-600 to-orange-600' },
                { icon: Globe, title: 'Alcance Mundial', desc: '50+ países cubiertos', gradient: 'from-blue-600 to-cyan-600' },
                { icon: Star, title: 'Excelencia', desc: '100% satisfacción', gradient: 'from-pink-600 to-rose-600' },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, scale: 0.9 }}
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-amber-400 uppercase tracking-wider">Expansión Mundial</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                <span className="gradient-text">Oportunidad de Franquicias en todo el Mundo</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Únase a nuestra red internacional y benefíciese de nuestra experiencia reconocida
              </p>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                <img
                  ...
                  alt="Oportunidad de franquicias internacionales"
                ...
                {[
                  {
                    icon: Globe,
                    title: 'Red Mundial',
                    desc: 'Ya presentes en 50+ países, continuamos nuestra expansión internacional',
                    gradient: 'from-amber-500 to-orange-600'
                  },
                  {
                    icon: Handshake,
                    title: 'Asociación Completa',
                    desc: 'Formación, soporte operacional y acceso a nuestra metodología probada',
                    gradient: 'from-violet-500 to-purple-600'
                  },
                  {
                    icon: TrendingUp,
                    title: 'Crecimiento Asegurado',
                    desc: 'Un modelo económico rentable con un acompañamiento personalizado',
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-violet-400 uppercase tracking-wider">Contacto</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                <span className="gradient-text">Contáctenos</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Nuestro equipo está listo para responder a todas sus preguntas
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="rounded-3xl bg-gradient-to-r from-violet-600/20 via-purple-600/20 to-amber-600/20 border-2 border-primary/30 p-8 sm:p-12 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-violet-400 uppercase tracking-wider">Comenzar</span>
              </div>
