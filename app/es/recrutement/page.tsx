  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
                <span className="gradient-text">Encuentre los Mejores Talentos Mundiales</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                De la selección a la integración, lo acompañamos en cada paso del reclutamiento internacional.
              </p>
                ...
                <div className="text-center mb-4">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30">
                    ...
                    <span className="text-sm font-medium text-amber-400 uppercase">
                      Permiso de Reclutamiento DETIE
                    </span>
                  </div>
                </div>
                <div className="rounded-2xl overflow-hidden border-2 border-amber-500/30 shadow-xl bg-background p-4">
                  <div className="relative w-full flex justify-center" style={{ height: '650px' }}>
                    <img
                      ...
                      alt="Permiso de Reclutamiento DETIE"
                      className="absolute"
                      style={{
                        height: '100%',
                        width: 'auto',
                ...
                <div className="mt-4 text-center">
                  <div className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-amber-500/10 border-2 border-amber-500/30">
                    ...
                    <div className="text-left">
                      <div className="text-xs text-amber-400/80 uppercase">Número del permiso</div>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="max-w-3xl">
                  <p className="text-lg sm:text-xl md:text-2xl font-bold leading-relaxed">
                    <span className="gradient-text">EL GABINETE DETIE TIENE COMO REFERENCIA EL SELLO ROJO DE CANADÁ EN EL DOMINIO DE LOS OFICIOS PARA SU RECLUTAMIENTO INTERNACIONAL</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div id="recruteur" className="rounded-3xl bg-gradient-to-br from-violet-500/10 to-purple-500/10 border-2 border-violet-500/30 p-6 sm:p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-violet-400">Soy Reclutador</h2>
                    <p className="text-sm text-muted-foreground">Empresas y Empleadores</p>
                  </div>
                </div>
                <p className="text-muted-foreground mb-6">
                  Acceda a un vivero mundial de talentos calificados. Gestionamos todo el proceso de reclutamiento por usted.
                </p>

                <div className="space-y-4 mb-6">
                  {[
                    { icon: Users, title: 'Reclutamiento Internacional', desc: 'Acceda a un vivero mundial de talentos calificados.' },
                    { icon: FileCheck, title: 'Gestión de Permisos', desc: 'Estudio de factibilidad LMIA y preparación CNESST.' },
              ...
              <div id="candidat" className="rounded-3xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border-2 border-emerald-500/30 p-6 sm:p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-emerald-400">Soy Candidato</h2>
                    <p className="text-sm text-muted-foreground">Trabajadores Internacionales</p>
                  </div>
                </div>
                <p className="text-muted-foreground mb-6">
                ...
                <div className="space-y-4 mb-6">
                  {[
                    ...
                    { icon: Globe, title: 'Soporte Jurídico', desc: 'Experiencia jurídica para todos sus trámites de inmigración.' },
                  ].map((service, i) => (
                    <div key={i} className="flex items-start gap-4 p-4 rounded-xl bg-background/50 border border-border">
        ...
        {/* Info Section - Reemplaza el formulario */}
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border-2 border-emerald-500/30 mb-6">
                ...
                <div className="text-left">
                  <div className="text-sm font-bold text-emerald-400">
                    EL GABINETE DETIE RESPETA Y PROTEGE SUS DATOS PERSONALES
                  </div>
                  <div className="text-xs text-emerald-400/80">
                    Cumplimiento RGPD • Datos seguros • Uso interno únicamente
                  </div>
                </div>
              </div>

              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                <span className="gradient-text">Cree su cuenta para continuar</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                Para postular a las ofertas o consultar los candidatos, debe crear una cuenta en nuestra plataforma segura.
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-6">
                ¿Ya tiene una cuenta?{' '}
                <Link href="/es/compte/connexion" className="text-violet-400 hover:text-violet-300 font-medium">
                  Iniciar sesión
                </Link>
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="rounded-3xl bg-gradient-to-r from-violet-600/20 to-purple-600/20 border-2 border-violet-500/30 p-8 sm:p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Contáctenos hoy mismo para hablar sobre sus necesidades de reclutamiento internacional.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/es/compte/inscription/recruteur"
