        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Cree su cuenta empresa para acceder a los candidatos
            </p>
          </div>
          ...
          <div className="mb-6 space-y-3">
            {[
              { title: 'Consultar los candidatos', desc: 'Acceso al vivero de talentos internacionales' },
              { title: 'Publicar ofertas', desc: 'Difunda sus oportunidades a los candidatos' },
              { title: 'Gestionar candidaturas', desc: 'Siga todas las candidaturas en tiempo real' },
              { title: 'Contacto directo', desc: 'Comunique directamente con los candidatos' },
            ].map((item, i) => (
          ...
          <div className="mb-6 p-4 rounded-xl bg-violet-500/10 border border-violet-500/20">
            <p className="text-sm text-violet-400">
              💡 <strong>Después de la inscripción</strong>, será redirigido a su espacio reclutador donde podrá configurar su perfil empresa.
            </p>
          </div>
