        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold mb-2 gradient-text">
              Mi Cuenta - Cabinet DETIE
            </h1>
            <p className="text-muted-foreground">
              Acceda a su panel personal
            </p>
          </div>
          ...
          <div className="mt-6 text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-4 text-sm">
              <Link href="/es/compte/inscription/candidat" className="text-violet-400 hover:text-violet-300 transition-colors">
                Soy Candidato
              </Link>
              <span className="text-muted-foreground">•</span>
              <Link href="/es/compte/inscription/recruteur" className="text-violet-400 hover:text-violet-300 transition-colors">
                Soy Reclutador
              </Link>
            </div>
          </div>
