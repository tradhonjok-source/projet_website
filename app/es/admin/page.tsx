...
export default function AdminPage() {
  ...
  const adminServices = [
    {
      icon: TrendingUp,
      title: 'Asesor en Reestructuración Financiera',
      desc: 'El gabinete ayuda a entidades en dificultad a superar sus crisis. Nuestro rol consiste en analizar la situación, negociar con acreedores, reestructurar la deuda y elaborar planes de recuperación para preservar el valor de la empresa y evitar la quiebra.',
    },
    {
      icon: Building2,
    ...
    {
      icon: Shield,
      title: 'Mandatario (Fideicomiso y Cuenta Fiduciaria)',
      desc: 'Nuestro gabinete, mandatario o administrador, gestiona el dinero de un tercero mediante herramientas precisas: el fideicomiso (para colocar y proteger bienes a largo plazo) y la cuenta en depósito (reservada a profesionales para guardar el dinero de los clientes de forma segura).',
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      desc: 'Nuestro gabinete concibe, desarrolla e implementa soluciones nuevas con socios en todo el mundo en una dinámica de mejora continua (productos, servicios, modelos de negocio o políticas) para responder de manera más sostenible a los desafíos sociales y ambientales.',
    },
    {
      icon: Bus,
      title: 'Programa HOTI PROS',
      desc: 'Una aplicación desarrollada con socios para la protección de usuarios del transporte colectivo y una transparencia en el ámbito del transporte remunerado de personas.',
    },
    {
      icon: BookOpen,
      title: 'Folleto Universal de Verificación Sumaria de Taxi',
      desc: 'El gabinete ha puesto a disposición de los profesionales del transporte remunerado una herramienta fácil de usar para la verificación de sus vehículos antes de la salida y editado en 3 idiomas (Francés-Inglés-Español).',
    },
  ];
  ...
  const careerServices = {
    ...
    items: [
      ...
      'Estrategia de búsqueda de empleo y orientación',
      'Orientación profesional',
      'Conformidad jurídica',
    ],
  };

  const lobbyingServices = [
    {
      icon: Globe,
      title: 'Lobbying ante Instituciones Internacionales',
      desc: 'El lobbying ante instituciones internacionales designa la acción de influenciar decisiones políticas, económicas o normativas en el seno de organismos mundiales como la OCDE, la ONU o la UE.',
    },
    {
      icon: Users,
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
            ...
            <div className="text-center max-w-4xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-amber-400 uppercase">
                  Administrador Certificado - Miembro de la Orden de Administradores Certificados de Quebec - Canadá
                </span>
              </div>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                Gabinete de experiencia multidisciplinaria que ofrece servicios profesionales certificados en Quebec y Canadá.
              </p>
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-amber-500/10 border-2 border-amber-500/30">
                ...
                <div className="text-left">
                  <div className="text-sm font-bold text-amber-400">N° LICENCIA AdmA A24-52400</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Section 1: Certified Administrator */}
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                <span className="gradient-text">Servicios de Administración Certificada</span>
              </h2>
            </div>

            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
              {adminServices.map((service, index) => (
                <div key={index} className="rounded-2xl bg-gradient-to-br from-violet-500/10 to-purple-500/10 border border-violet-500/30 p-6 hover:border-violet-500/60 transition-all">
        ...
        <section className="py-20 md:py-32 bg-secondary/30">
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 p-8 hover:border-emerald-500/60 transition-all">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600">
                    <careerServices.icon className="h-7 w-7 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-emerald-400">{careerServices.title}</h3>
                </div>
                <p className="text-muted-foreground mb-6">{careerServices.desc}</p>
                <ul className="grid gap-3 md:grid-cols-2">
                  {careerServices.items.map((item, i) => (
        ...
        <section className="py-20 md:py-32">
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                <span className="gradient-text">Consultoría para Organizaciones Lucrativas y No Lucrativas</span>
              </h2>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="rounded-3xl bg-gradient-to-r from-amber-600/20 to-orange-600/20 border-2 border-amber-500/30 p-8 sm:p-12 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">¿Necesita Asistencia Profesional?</h2>
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Nuestro equipo de expertos está listo para guiarlo en todos sus trámites.
              </p>
